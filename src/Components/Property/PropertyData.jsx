...
export default function PropertyData() {
    ...
    const Data = [
        ...
        {
            id: 1,
            img: "assets/images/Property/Villa1.webp",
        ...
        {
            id: 2,
            img: "assets/images/Property/Villa2.jpg",
        ...
        {
            id: 3,
            img: "assets/images/Property/Villa3.png",
        ...
        {
            id: 4,
            img: "assets/images/Property/VIlla4.jpeg",
            title: "Virtual Villa",
            Payment: "$2000.00 /M",
            btnText: "Learn More",
            bed: 2,
        ...
        {
            id: 5,
            img: "assets/images/Property/Villa5.jpg",
            title: "Premium Villa",
            Payment: "$3000.00 /M",
            btnText: "Learn More",
            bed: 3,
        ...
        {
            id: 6,
            img: "assets/images/Property/Villa6.jpg",
